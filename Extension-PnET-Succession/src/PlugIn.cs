...
namespace Landis.Extension.Succession.BiomassPnET
{
    public class PlugIn : Landis.Library.Succession.ExtensionBase
    {
        ...
        //These variables are added to adjust seedling survival for SW forests.
        //AKeyser Oct 2020
        public static ISiteVar<float> pSurvSW;
        ...
        public override void Initialize()
        {
            ...
            // Added AKeyser Sept 2020
            // Get/Set slope, HLI, Prob survival SW, also  define at top for access
            pSurvSW = PlugIn.ModelCore.Landscape.NewSiteVar<float>();
            ...
            foreach (ActiveSite site in PlugIn.ModelCore.Landscape)
            {
                ...
                pSurvSW[site] = 0; //Added AKeyser Sept 2020
